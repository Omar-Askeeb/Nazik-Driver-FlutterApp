...
import 'schema/money_transfer_record.dart';
import 'schema/drivers_record.dart';
import 'schema/admin_notification_record.dart';
import 'schema/driver_user_record.dart';
...
export 'schema/money_transfer_record.dart';
export 'schema/drivers_record.dart';
export 'schema/admin_notification_record.dart';
export 'schema/driver_user_record.dart';
...
/// Functions to query MoneyTransferRecords (as a Stream and as a Future).
Future<int> queryMoneyTransferRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MoneyTransferRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MoneyTransferRecord>> queryMoneyTransferRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MoneyTransferRecord.collection,
      MoneyTransferRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MoneyTransferRecord>> queryMoneyTransferRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DriverUserRecords (as a Stream and as a Future).
Future<int> queryDriverUserRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DriverUserRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DriverUserRecord>> queryDriverUserRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DriverUserRecord.collection,
      DriverUserRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DriverUserRecord>> queryDriverUserRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future maybeCreateUser(User user) async {
  final userRecord = DriverUserRecord.collection.doc(user.uid);
  final userExists = await userRecord.get().then((u) => u.exists);
  if (userExists) {
    currentUserDocument = await DriverUserRecord.getDocumentOnce(userRecord);
    return;
  }

  final userData = createDriverUserRecordData(
    email: user.email,
    displayName:
  ...
  currentUserDocument =
      DriverUserRecord.getDocumentFromData(userData, userRecord);
}

Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference
      .update(createDriverUserRecordData(email: email));
}
