...
DocumentReference? get currentUserReference =>
    loggedIn ? DriverUserRecord.collection.doc(currentUser!.uid) : null;

DriverUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : DriverUserRecord.getDocument(DriverUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
